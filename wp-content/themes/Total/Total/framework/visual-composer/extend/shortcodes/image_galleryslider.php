<?php
/**
 * Registers the gallery slider shortcode
 *
 * @package WordPress
 * @subpackage Total
 * @since Total 1.41
	...
	function vcex_image_galleryslider_shortcode($atts) {
		...
		if( $attachments ) :
			...
			<div class="vcex-flexslider-wrap clr vcex-img-galleryslider <?php echo $img_rendering; ?>" <?php echo $unique_id; ?>>
				<div class="vcex-galleryslider flexslider wpex-gallery-lightbox" <?php echo $flexslider_data; ?>>
					<ul class="slides">
						<?php
							...
							<li class="vcex-galleryslider-slide slide" data-thumb="<?php echo $img_thumb; ?>">
								<div class="vcex-galleryslider-entry-media">
									...
									if ( $thumbnail_link == 'lightbox' ) { ?>
										<a href="<?php echo $attachment_img_url; ?>" title="<?php echo $attachment_alt; ?>" class="vcex-galleryslider-entry-img">
...
/**
 * Adds the gallery slider shortcode to the Visual Composer
 *
 * @package WordPress
 * @subpackage Total
 * @since Total 1.41
