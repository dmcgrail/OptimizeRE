<?php
/**
 * Registers the flexslider shortcode
 *
 * @package WordPress
 * @subpackage Total
 * @since Total 1.41
						...
						<li class="vcex-flexslider-slide slide <?php echo $img_rendering; ?>" <?php echo $data_thumb; ?>>
							<div class="vcex-flexslider-entry-media">
								...
								if ( 'true' == $caption && $attachment_caption ) { ?>
									...
									</div><!-- END .vcex-flexslider-entry-caption -->
								<?php } ?>
							</div><!-- END .vcex-flexslider-entry-media -->
						</li>
					<?php endforeach; ?>
					</ul>
				</div>
...
/**
 * Adds the flexslider shortcode to the Visual Composer
 *
 * @package WordPress
 * @subpackage Total
 * @since Total 1.41
